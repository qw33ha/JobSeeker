...
\item    Wang Wenzhi --- Modules MIS; Description of implementation; Trace back to requirements; Internal review.
\item    Gengyun Wang --- Modules MIS; Description of implementation and two UML for two most interesting classes; Internal review.
\end{description}
\newpage
